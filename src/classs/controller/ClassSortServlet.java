...
/**
 * Servlet implementation class ClassSortServlet
 */
@WebServlet("/classsort")
public class ClassSortServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ClassSortServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Classs> list = cservice.selectList2(startRow, endRow); 
		RequestDispatcher view = null;
		
		if(list.size() > 0) {
			view = request.getRequestDispatcher("views/classcrud/classUpdate2.jsp");
