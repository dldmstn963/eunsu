...
<body class="w3-theme-l5">
	...
	<div class="w3-container w3-content"
		...
		<div id="pagebox" align="center">
			<a href="/eunsu/departmentlist?page=1">|◁</a>&nbsp;
			<% if((beginPage - 10) < 1){ %>
			<a href="/eunsu/departmentlist?page=1">◀◀</a>&nbsp;
			<%}else{ %>
			<a href="/eunsu/departmentlist?page=<%= beginPage - 10%>">◀◀</a>&nbsp;
			<%} %>
			<% for(int p = beginPage; p <= endPage; p++){
				if(p == currentPage){%>
				<a href="/eunsu/departmentlist?page=<%= p%>"><font color="red"><b>[<%=p %>]</b></font></a>&nbsp;			
				<%}else{ %>
				<a href="/eunsu/departmentlist?page=<%= p%>"><%=p %></a>&nbsp;
				<%}} %>
			
			<% if((endPage + 10)>maxPage){%>
				<a href="/eunsu/departmentlist?page=<%= maxPage%>">▶▶</a>&nbsp;
			<%}else{ %>
				<a href="/eunsu/departmentlist?page=<%= endPage + 10%>">▶▶</a>&nbsp;
			<%} %>
				<a href="/eunsu/departmentlist?page=<%= maxPage%>">▷|</a>&nbsp;
