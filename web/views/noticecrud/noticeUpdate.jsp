...
<body class="w3-theme-l5">
	...
	<div class="w3-container w3-content"
		...
		<form action="/eunsu/noticeupdate" method="post" enctype="multipart/form-data">
		<table align="center" border="1" cellspacing="0" cellpadding="3">
			<input type="hidden" name="nono" value="<%=notice.getNoticeNo() %>">
			<input type="hidden" name="noemp" value="<%=notice.getEmployeeNo() %>">
			<input type="hidden" name="page" value="<%=currentPage %>">
			<input type="hidden" name="noviews" value="<%=notice.getViews() %>">
			<input type="hidden" name="noorifile" value="<%=notice.getOriFile()%>">
			<input type="hidden" name="norefile" value="<%=notice.getReFile()%>">
			<tr>
			<th>번호</th>
			...
			<tr>
			<th>제목</th>
			<td><input type="text" name="notitle" value="<%=notice.getNoticeTitle() %>"></td>
			</tr>
			
			<tr>
			<th>글쓴이</th>
			<td><%=notice.getEmployeeNo() %></td>
			</tr>
			...
			<tr>
			<th>내용</th>
			<td><textarea rows="5" cols="70" name="nocontent"> <%=notice.getNoticecontent()%></textarea></td>
			</tr>
		...
		<input type="button" value="이전페이지" onclick="history.go(-1); return false;">
		</center>
		</form>
		<br>
