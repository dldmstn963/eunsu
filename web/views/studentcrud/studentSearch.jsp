...
<%
	...
	String searchpro = ((String)request.getAttribute("searchpro").toString());
%>
<!DOCTYPE html>
<html>
<title>수은 대학교</title>
...
<body class="w3-theme-l5">
	...
	<div class="w3-card w3-round">
		...
		<div id="pagebox" align="center">
			<a href="/eunsu/studentsearch?page=1&searchno=<%= searchno%>&searchname=<%=searchname %>&searchdepart=<%=searchdepart %>&searchopen=<%= searchopen%>&searchpro=<%= searchpro%>">|◁</a>&nbsp;
			<% if((beginPage - 10) < 1){ %>
			<a href="/eunsu/studentsearch?page=1&searchno=<%= searchno%>&searchname=<%=searchname %>&searchdepart=<%=searchdepart %>&searchopen=<%= searchopen%>&searchpro=<%= searchpro%>">◀◀</a>&nbsp;
			<%}else{ %>
			<a href="/eunsu/studentsearch?page=<%= beginPage - 10%>&searchno=<%= searchno%>&searchname=<%=searchname %>&searchdepart=<%=searchdepart %>&searchopen=<%= searchopen%>&searchpro=<%= searchpro%>">◀◀</a>&nbsp;
			<%} %>
			<% for(int p = beginPage; p <= endPage; p++){
				if(p == currentPage){%>
				<a href="/eunsu/studentsearch?page=<%= p%>&searchno=<%= searchno%>&searchname=<%=searchname %>&searchdepart=<%=searchdepart %>&searchopen=<%= searchopen%>&searchpro=<%= searchpro%>"><font color="red"><b>[<%=p %>]</b></font></a>&nbsp;			
				<%}else{ %>
				<a href="/eunsu/studentsearch?page=<%= p%>&searchno=<%= searchno%>&searchname=<%=searchname %>&searchdepart=<%=searchdepart %>&searchopen=<%= searchopen%>&searchpro=<%= searchpro%>"><%=p %></a>&nbsp;
				<%}} %>
			
			<% if((endPage + 10)>maxPage){%>
				<a href="/eunsu/studentsearch?page=<%= maxPage%>&searchno=<%= searchno%>&searchname=<%=searchname %>&searchdepart=<%=searchdepart %>&searchopen=<%= searchopen%>&searchpro=<%= searchpro%>">▶▶</a>&nbsp;
			<%}else{ %>
				<a href="/eunsu/studentsearch?page=<%= endPage + 10%>&searchno=<%= searchno%>&searchname=<%=searchname %>&searchdepart=<%=searchdepart %>&searchopen=<%= searchopen%>&searchpro=<%= searchpro%>">▶▶</a>&nbsp;
			<%} %>
				<a href="/eunsu/studentsearch?page=<%= maxPage%>&searchno=<%= searchno%>&searchname=<%=searchname %>&searchdepart=<%=searchdepart %>&searchopen=<%= searchopen%>&searchpro=<%= searchpro%>">▷|</a>&nbsp;
